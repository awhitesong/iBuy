...
<body>
    ...
    %>
    <%    ResultSet re=(ResultSet)request.getAttribute("attri"); %>
	...
	<div class="container" style="padding-top:70px;">
		...
		<form method="post" action='' name="cart">
			        <input type="submit" class="btn btn-danger" name="remove" value="Remove All" > 
        </form>	<br>
        <form method="post" action='order.html' name="cart">
